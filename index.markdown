...
<div id="funcionalidades" class="container mx-auto px-4 py-24">
  <div class="text-center mb-16">
    <h2 class="text-3xl md:text-4xl font-bold mb-4">Funcionalidades Principales</h2>
    <p class="text-gray-600 max-w-2xl mx-auto">Diseñado para garantizar que tu información vital esté protegida y llegue a las personas adecuadas cuando más lo necesiten</p>
  </div>
  <div class="grid md:grid-cols-3 gap-8">
    <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
      ...
      <h3 class="text-xl font-bold mb-4">Almacenamiento Seguro</h3>
      <p class="text-gray-600">Guarda archivos, documentos, imágenes, videos y notas importantes en un lugar seguro con cifrado avanzado.</p>
    </div>
    <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
      <div class="text-blue-600 mb-6 transform group-hover:scale-110 transition-transform duration-300">
        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
      </div>
      <h3 class="text-xl font-bold mb-4">Gestión de Beneficiarios</h3>
      <p class="text-gray-600">Asigna beneficiarios específicos para distintos tipos de información, controlando quién accede a qué cuando ya no estés.</p>
    </div>
    <div class="group bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
      <div class="text-blue-600 mb-6 transform group-hover:scale-110 transition-transform duration-300">
        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
      </div>
      <h3 class="text-xl font-bold mb-4">Verificación de Estado</h3>
      <p class="text-gray-600">Sistema de verificación periódica para confirmar tu estado y activar el acceso a beneficiarios cuando sea necesario.</p>
    </div>
  </div>
</div>
...
<div class="bg-gray-50 py-24">
  <div class="container mx-auto px-4">
    <div class="text-center mb-16">
      ...
      <p class="text-gray-600 max-w-2xl mx-auto">Un proceso simple que garantiza la seguridad de tu información y el cumplimiento de tus deseos</p>
    </div>
    <div class="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
      <div class="relative">
        ...
        <div class="text-center">
          <h3 class="text-lg font-semibold mb-2">Regístrate</h3>
          <p class="text-gray-600">Crea tu cuenta y configura tu perfil personal.</p>
        </div>
        <div class="absolute top-8 left-full w-full h-0.5 bg-blue-200 hidden md:block" style="width: calc(100% - 3rem);"></div>
      </div>
      <div class="relative">
